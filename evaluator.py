...
class Evaluator:
    def __init__(self, prefix="", verbose=False, repeat=1, folds=10, algorithms=None, column_groups=None, alphas=None):
        self.repeat = repeat
        self.folds = folds
        ...
        if self.alphas is None:
            self.alphas = [0.5 for i in range(len(self.algorithms))]
    ...
    def process_coolumn_group(self, repeat_number, index_algorithm, index_column_group):
        ...
        alpha = self.alphas[index_algorithm]
